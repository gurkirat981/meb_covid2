...
<<<<<<< HEAD
```{r, include=FALSE}
#In the following code, we have converted all character responses to numeric values for the ease of calculating average responses later on.  

#Q7 (X16), Q13(X130), Q15 (X132), Leaving Q19 (X136) as is since this is the error question, Q8 (X17), Q9 (X18)
#X133 (Question 16), X134 (Question 17), X135 (Question 18), X137 (Question 20), X138 (Question 21), X139 (Question 22)
