...
ias_processed_dta<-nocombined_ias %>% 
  ...
  mutate(sdg = ifelse(State == "Uttar Pradesh" | State == "Bihar" | State == "Assam", "Aspirant", 
                       ifelse(State=="Puducherry"|State=="Tamil Nadu"| State=="Chandigarh"| State=="Himachal Pradesh"|State =="Kerala", "Frontrunner", "Performer"))) %>% 
  mutate(state_young_weight = pre2012/ sum(pre2012)) %>% 
  mutate(state_old_weight = post2012/ sum(post2012)) 
...
summary_state_analysis_young<-summary_state_young %>% 
  mutate(state_young_weight=ias_young$state_young_weight) 

ias_old<-ias_processed_dta %>% 
  filter(!State=="Nagaland")
summary_state_analysis_old<-summary_state_old %>% 
  mutate(state_old_weight=ias_old$state_old_weight)  
```
...
#Age 
q1young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X16ones, summary_state_analysis_young$state_young_weight)*100,2) 
q1young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X16twos, summary_state_analysis_young$state_young_weight)*100,2) 
...
q1old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X16ones, summary_state_analysis_old$state_old_weight)*100,2) 
q1old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X16twos, summary_state_analysis_old$state_old_weight)*100,2) 
...
q1aspt_plot <- ggplot(q1aspt_plot_dta, aes(x=q1full_plot_labels, y=q1aspt_plot, fill = q1full_plot_labels)) +
  geom_bar(stat="identity", width= 0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q1aspt_plot),"%"), vjust=-0.3), size=7) +
  scale_y_continuous(limits = c(0,100)) +  
  scale_x_discrete(labels= c("",""))  +
  scale_fill_brewer(palette="YlGnBu") +
...
q1perf_plot <- ggplot(q1perf_plot_dta, aes(x=q1full_plot_labels, y=q1perf_plot, fill = q1full_plot_labels)) +
  geom_bar(stat="identity", width= 0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q1perf_plot),"%"), vjust=-0.3), size=7) +
  scale_y_continuous(limits = c(0,100)) +  
  scale_x_discrete(labels= c("",""))  +
  scale_fill_brewer(palette="YlGnBu") +
...
q1frnt_plot_temp <- ggplot(q1frnt_plot_dta, aes(x=q1full_plot_labels, y=q1frnt_plot, fill = q1full_plot_labels)) +
  ...
  geom_text(aes(label=paste0(sprintf("%0.2f", q1frnt_plot),"%"), vjust=-0.3), size=7) +
  scale_y_continuous(limits = c(0,100)) +  
  scale_x_discrete(labels= c("","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q1_fullsdg <- plot_grid(q1_fullsdg,legend1, nrow = 2, rel_heights=c(5,1))
...
```{r, echo = FALSE, fig.height=10,fig.width=18}
#Age
q2young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X17ones, summary_state_analysis_young$state_young_weight)*100,2) 
q2young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X17twos, summary_state_analysis_young$state_young_weight)*100,2)
q2young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X17threes, summary_state_analysis_young$state_young_weight)*100,2)
q2young_mean_fours <- round(weighted.mean(summary_state_analysis_young$X17fours, summary_state_analysis_young$state_young_weight)*100,2)
...
q2old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X17ones, summary_state_analysis_old$state_old_weight)*100,2) 
q2old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X17twos, summary_state_analysis_old$state_old_weight)*100,2)
q2old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X17threes, summary_state_analysis_old$state_old_weight)*100,2)
q2old_mean_fours <- round(weighted.mean(summary_state_analysis_old$X17fours, summary_state_analysis_old$state_old_weight)*100,2)
...
plot2_fullage <- plot_grid(plot2_fullage, legend2, nrow = 2, rel_heights=c(5,1)) 
plot2_fullage 
```
\newpage
...
q2aspt_plot <- ggplot(q2aspt_plot_dta, aes(x=q2full_plot_labels, y=q2aspt_plot, fill = q2full_plot_labels)) +
  geom_bar(stat="identity", width=0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q2aspt_plot),"%"), vjust=-0.3), size=6) +
  scale_y_continuous(limits = c(0,100))  +
  labs(x="",y="Percent")  +
  scale_x_discrete(labels= c("","","","","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q2perf_plot <- ggplot(q2perf_plot_dta, aes(x=q2full_plot_labels, y=q2perf_plot, fill = q2full_plot_labels)) +
  geom_bar(stat="identity", width=0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q2perf_plot),"%"), vjust=-0.3), size=6) +
  scale_y_continuous(limits = c(0,100)) +
  labs(x="",y="Percent") +
  scale_x_discrete(labels= c("","","","","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q2frnt_plot_temp <- ggplot(q2frnt_plot_dta, aes(x=q2full_plot_labels, y=q2frnt_plot, fill = q2full_plot_labels)) +
  geom_bar(stat="identity", width=0.5, show.legend = TRUE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q2frnt_plot),"%"), vjust=-0.3), size=6) +
  scale_y_continuous(limits = c(0,100)) +
  labs(x="",y="Percent") +
  scale_x_discrete(labels= c("","","","","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q2_fullsdg <- plot_grid(q2_fullsdg,legend2, nrow = 2, rel_heights=c(5,1))
...
```{r, echo = FALSE, fig.height=10,fig.width=18}
#Age
q3young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X18ones, summary_state_analysis_young$state_young_weight)*100,2) 
q3young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X18twos, summary_state_analysis_young$state_young_weight)*100,2)
q3young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X18threes, summary_state_analysis_young$state_young_weight)*100,2)
q3young_mean_fours <- round(weighted.mean(summary_state_analysis_young$X18fours, summary_state_analysis_young$state_young_weight)*100,2)
...
q3old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X18ones, summary_state_analysis_old$state_old_weight)*100,2) 
q3old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X18twos, summary_state_analysis_old$state_old_weight)*100,2)
q3old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X18threes, summary_state_analysis_old$state_old_weight)*100,2)
q3old_mean_fours <- round(weighted.mean(summary_state_analysis_old$X18fours, summary_state_analysis_old$state_old_weight)*100,2)
...
plot3_fullage <- plot_grid(plot3_fullage, legend3, nrow = 2, rel_heights=c(5,1)) 
plot3_fullage 
```
\newpage
...
q3aspt_plot <- ggplot(q3aspt_plot_dta, aes(x=q3full_plot_labels, y=q3aspt_plot, fill = q3full_plot_labels)) +
  geom_bar(stat="identity", width=0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q3aspt_plot),"%"), vjust=-0.3), size=6) +
  scale_y_continuous(limits = c(0,100))  +
  labs(x="",y="Percent")  +
  scale_x_discrete(labels= c("","","","","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q3perf_plot <- ggplot(q3perf_plot_dta, aes(x=q3full_plot_labels, y=q3perf_plot, fill = q3full_plot_labels)) +
  geom_bar(stat="identity", width=0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q3perf_plot),"%"), vjust=-0.3), size=6) +
  scale_y_continuous(limits = c(0,100)) +
  labs(x="",y="Percent") +
  scale_x_discrete(labels= c("","","","","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q3_fullsdg <- plot_grid(q3_fullsdg,legend3, nrow = 2, rel_heights=c(5,1))
...
#Age
q4young_mean_anislands <- round(weighted.mean(summary_q4_young$q4_anislands, summary_q4_young$state_young_weight)*100,2)
q4young_mean_andhra <- round(weighted.mean(summary_q4_young$q4_andhra, summary_q4_young$state_young_weight)*100,2)
q4young_mean_arunachal <- round(weighted.mean(summary_q4_young$q4_arunachal, summary_q4_young$state_young_weight)*100,2)
q4young_mean_assam <- round(weighted.mean(summary_q4_young$q4_assam, summary_q4_young$state_young_weight)*100,2)
q4young_mean_bihar <- round(weighted.mean(summary_q4_young$q4_bihar, summary_q4_young$state_young_weight)*100,2)
q4young_mean_chandigarh <- round(weighted.mean(summary_q4_young$q4_chandigarh, summary_q4_young$state_young_weight)*100,2)
q4young_mean_chhattisgarh <- round(weighted.mean(summary_q4_young$q4_chhattisgarh, summary_q4_young$state_young_weight)*100,2)
q4young_mean_dnhdd <- round(weighted.mean(summary_q4_young$q4_dnhdd, summary_q4_young$state_young_weight)*100,2)
q4young_mean_goa <- round(weighted.mean(summary_q4_young$q4_goa, summary_q4_young$state_young_weight)*100,2)
q4young_mean_gujarat <- round(weighted.mean(summary_q4_young$q4_gujarat, summary_q4_young$state_young_weight)*100,2)
q4young_mean_haryana <- round(weighted.mean(summary_q4_young$q4_haryana, summary_q4_young$state_young_weight)*100,2)
q4young_mean_hp <- round(weighted.mean(summary_q4_young$q4_hp, summary_q4_young$state_young_weight)*100,2)
q4young_mean_jk <- round(weighted.mean(summary_q4_young$q4_jk, summary_q4_young$state_young_weight)*100,2)
q4young_mean_jharkhand <- round(weighted.mean(summary_q4_young$q4_jharkhand, summary_q4_young$state_young_weight)*100,2)
q4young_mean_karnataka <- round(weighted.mean(summary_q4_young$q4_karnataka, summary_q4_young$state_young_weight)*100,2)
q4young_mean_kerala <- round(weighted.mean(summary_q4_young$q4_kerala, summary_q4_young$state_young_weight)*100,2)
q4young_mean_ladakh <- round(weighted.mean(summary_q4_young$q4_ladakh, summary_q4_young$state_young_weight)*100,2)
q4young_mean_lakshadweep <- round(weighted.mean(summary_q4_young$q4_lakshadweep, summary_q4_young$state_young_weight)*100,2)
q4young_mean_mp <- round(weighted.mean(summary_q4_young$q4_mp, summary_q4_young$state_young_weight)*100,2)
q4young_mean_maharashtra <- round(weighted.mean(summary_q4_young$q4_maharashtra, summary_q4_young$state_young_weight)*100,2)
q4young_mean_manipur <- round(weighted.mean(summary_q4_young$q4_manipur, summary_q4_young$state_young_weight)*100,2)
q4young_mean_meghalaya <- round(weighted.mean(summary_q4_young$q4_meghalaya, summary_q4_young$state_young_weight)*100,2)
q4young_mean_mizoram <- round(weighted.mean(summary_q4_young$q4_mizoram, summary_q4_young$state_young_weight)*100,2)
q4young_mean_nagaland <- round(weighted.mean(summary_q4_young$q4_nagaland, summary_q4_young$state_young_weight)*100,2)
q4young_mean_delhi <- round(weighted.mean(summary_q4_young$q4_delhi, summary_q4_young$state_young_weight)*100,2)
q4young_mean_none <- round(weighted.mean(summary_q4_young$q4_none, summary_q4_young$state_young_weight)*100,2)
q4young_mean_odisha <- round(weighted.mean(summary_q4_young$q4_odisha, summary_q4_young$state_young_weight)*100,2)
q4young_mean_puducherry <- round(weighted.mean(summary_q4_young$q4_puducherry, summary_q4_young$state_young_weight)*100,2)
q4young_mean_punjab <- round(weighted.mean(summary_q4_young$q4_punjab, summary_q4_young$state_young_weight)*100,2)
q4young_mean_rajasthan <- round(weighted.mean(summary_q4_young$q4_rajasthan, summary_q4_young$state_young_weight)*100,2)
q4young_mean_sikkim <- round(weighted.mean(summary_q4_young$q4_sikkim, summary_q4_young$state_young_weight)*100,2)
q4young_mean_tn <- round(weighted.mean(summary_q4_young$q4_tn, summary_q4_young$state_young_weight)*100,2)
q4young_mean_telangana <- round(weighted.mean(summary_q4_young$q4_telangana, summary_q4_young$state_young_weight)*100,2)
q4young_mean_tripura <- round(weighted.mean(summary_q4_young$q4_tripura, summary_q4_young$state_young_weight)*100,2)
q4young_mean_up <- round(weighted.mean(summary_q4_young$q4_up, summary_q4_young$state_young_weight)*100,2)
q4young_mean_uttarakhand <- round(weighted.mean(summary_q4_young$q4_uttarakhand, summary_q4_young$state_young_weight)*100,2)
q4young_mean_wb <- round(weighted.mean(summary_q4_young$q4_wb, summary_q4_young$state_young_weight)*100,2)
...
q4old_mean_anislands <- round(weighted.mean(summary_q4_old$q4_anislands, summary_q4_old$state_old_weight)*100,2)
q4old_mean_andhra <- round(weighted.mean(summary_q4_old$q4_andhra, summary_q4_old$state_old_weight)*100,2)
q4old_mean_arunachal <- round(weighted.mean(summary_q4_old$q4_arunachal, summary_q4_old$state_old_weight)*100,2)
q4old_mean_assam <- round(weighted.mean(summary_q4_old$q4_assam, summary_q4_old$state_old_weight)*100,2)
q4old_mean_bihar <- round(weighted.mean(summary_q4_old$q4_bihar, summary_q4_old$state_old_weight)*100,2)
q4old_mean_chandigarh <- round(weighted.mean(summary_q4_old$q4_chandigarh, summary_q4_old$state_old_weight)*100,2)
q4old_mean_chhattisgarh <- round(weighted.mean(summary_q4_old$q4_chhattisgarh, summary_q4_old$state_old_weight)*100,2)
q4old_mean_dnhdd <- round(weighted.mean(summary_q4_old$q4_dnhdd, summary_q4_old$state_old_weight)*100,2)
q4old_mean_goa <- round(weighted.mean(summary_q4_old$q4_goa, summary_q4_old$state_old_weight)*100,2)
q4old_mean_gujarat <- round(weighted.mean(summary_q4_old$q4_gujarat, summary_q4_old$state_old_weight)*100,2)
q4old_mean_haryana <- round(weighted.mean(summary_q4_old$q4_haryana, summary_q4_old$state_old_weight)*100,2)
q4old_mean_hp <- round(weighted.mean(summary_q4_old$q4_hp, summary_q4_old$state_old_weight)*100,2)
q4old_mean_jk <- round(weighted.mean(summary_q4_old$q4_jk, summary_q4_old$state_old_weight)*100,2)
q4old_mean_jharkhand <- round(weighted.mean(summary_q4_old$q4_jharkhand, summary_q4_old$state_old_weight)*100,2)
q4old_mean_karnataka <- round(weighted.mean(summary_q4_old$q4_karnataka, summary_q4_old$state_old_weight)*100,2)
q4old_mean_kerala <- round(weighted.mean(summary_q4_old$q4_kerala, summary_q4_old$state_old_weight)*100,2)
q4old_mean_ladakh <- round(weighted.mean(summary_q4_old$q4_ladakh, summary_q4_old$state_old_weight)*100,2)
q4old_mean_lakshadweep <- round(weighted.mean(summary_q4_old$q4_lakshadweep, summary_q4_old$state_old_weight)*100,2)
q4old_mean_mp <- round(weighted.mean(summary_q4_old$q4_mp, summary_q4_old$state_old_weight)*100,2)
q4old_mean_maharashtra <- round(weighted.mean(summary_q4_old$q4_maharashtra, summary_q4_old$state_old_weight)*100,2)
q4old_mean_manipur <- round(weighted.mean(summary_q4_old$q4_manipur, summary_q4_old$state_old_weight)*100,2)
q4old_mean_meghalaya <- round(weighted.mean(summary_q4_old$q4_meghalaya, summary_q4_old$state_old_weight)*100,2)
q4old_mean_mizoram <- round(weighted.mean(summary_q4_old$q4_mizoram, summary_q4_old$state_old_weight)*100,2)
q4old_mean_nagaland <- round(weighted.mean(summary_q4_old$q4_nagaland, summary_q4_old$state_old_weight)*100,2)
q4old_mean_delhi <- round(weighted.mean(summary_q4_old$q4_delhi, summary_q4_old$state_old_weight)*100,2)
q4old_mean_none <- round(weighted.mean(summary_q4_old$q4_none, summary_q4_old$state_old_weight)*100,2)
q4old_mean_odisha <- round(weighted.mean(summary_q4_old$q4_odisha, summary_q4_old$state_old_weight)*100,2)
q4old_mean_puducherry <- round(weighted.mean(summary_q4_old$q4_puducherry, summary_q4_old$state_old_weight)*100,2)
q4old_mean_punjab <- round(weighted.mean(summary_q4_old$q4_punjab, summary_q4_old$state_old_weight)*100,2)
q4old_mean_rajasthan <- round(weighted.mean(summary_q4_old$q4_rajasthan, summary_q4_old$state_old_weight)*100,2)
q4old_mean_sikkim <- round(weighted.mean(summary_q4_old$q4_sikkim, summary_q4_old$state_old_weight)*100,2)
q4old_mean_tn <- round(weighted.mean(summary_q4_old$q4_tn, summary_q4_old$state_old_weight)*100,2)
q4old_mean_telangana <- round(weighted.mean(summary_q4_old$q4_telangana, summary_q4_old$state_old_weight)*100,2)
q4old_mean_tripura <- round(weighted.mean(summary_q4_old$q4_tripura, summary_q4_old$state_old_weight)*100,2)
q4old_mean_up <- round(weighted.mean(summary_q4_old$q4_up, summary_q4_old$state_old_weight)*100,2)
q4old_mean_uttarakhand <- round(weighted.mean(summary_q4_old$q4_uttarakhand, summary_q4_old$state_old_weight)*100,2)
q4old_mean_wb <- round(weighted.mean(summary_q4_old$q4_wb, summary_q4_old$state_old_weight)*100,2)
...
Please select upto two States that you think have best fulfilled their pandemic management responsibilities. 
\vspace{6mm}
```{r, echo = FALSE, fig.height=11,fig.width=18, warning=FALSE}
summary_q4 <- summary_q4 %>% 
mutate (sdg_tier = ias_processed_dta$sdg)
...
```{r, echo = FALSE, fig.height=10,fig.width=18, warning=FALSE}
#Age
q5young_mean_anislands <- round(weighted.mean(summary_q5_young$q5_anislands, summary_q5_young$state_young_weight)*100,2)
q5young_mean_andhra <- round(weighted.mean(summary_q5_young$q5_andhra, summary_q5_young$state_young_weight)*100,2)
q5young_mean_arunachal <- round(weighted.mean(summary_q5_young$q5_arunachal, summary_q5_young$state_young_weight)*100,2)
q5young_mean_assam <- round(weighted.mean(summary_q5_young$q5_assam, summary_q5_young$state_young_weight)*100,2)
q5young_mean_bihar <- round(weighted.mean(summary_q5_young$q5_bihar, summary_q5_young$state_young_weight)*100,2)
q5young_mean_chandigarh <- round(weighted.mean(summary_q5_young$q5_chandigarh, summary_q5_young$state_young_weight)*100,2)
q5young_mean_chhattisgarh <- round(weighted.mean(summary_q5_young$q5_chhattisgarh, summary_q5_young$state_young_weight)*100,2)
q5young_mean_dnhdd <- round(weighted.mean(summary_q5_young$q5_dnhdd, summary_q5_young$state_young_weight)*100,2)
q5young_mean_goa <- round(weighted.mean(summary_q5_young$q5_goa, summary_q5_young$state_young_weight)*100,2)
q5young_mean_gujarat <- round(weighted.mean(summary_q5_young$q5_gujarat, summary_q5_young$state_young_weight)*100,2)
q5young_mean_haryana <- round(weighted.mean(summary_q5_young$q5_haryana, summary_q5_young$state_young_weight)*100,2)
q5young_mean_hp <- round(weighted.mean(summary_q5_young$q5_hp, summary_q5_young$state_young_weight)*100,2)
q5young_mean_jk <- round(weighted.mean(summary_q5_young$q5_jk, summary_q5_young$state_young_weight)*100,2)
q5young_mean_jharkhand <- round(weighted.mean(summary_q5_young$q5_jharkhand, summary_q5_young$state_young_weight)*100,2)
q5young_mean_karnataka <- round(weighted.mean(summary_q5_young$q5_karnataka, summary_q5_young$state_young_weight)*100,2)
q5young_mean_kerala <- round(weighted.mean(summary_q5_young$q5_kerala, summary_q5_young$state_young_weight)*100,2)
q5young_mean_ladakh <- round(weighted.mean(summary_q5_young$q5_ladakh, summary_q5_young$state_young_weight)*100,2)
q5young_mean_lakshadweep <- round(weighted.mean(summary_q5_young$q5_lakshadweep, summary_q5_young$state_young_weight)*100,2)
q5young_mean_mp <- round(weighted.mean(summary_q5_young$q5_mp, summary_q5_young$state_young_weight)*100,2)
q5young_mean_maharashtra <- round(weighted.mean(summary_q5_young$q5_maharashtra, summary_q5_young$state_young_weight)*100,2)
q5young_mean_manipur <- round(weighted.mean(summary_q5_young$q5_manipur, summary_q5_young$state_young_weight)*100,2)
q5young_mean_meghalaya <- round(weighted.mean(summary_q5_young$q5_meghalaya, summary_q5_young$state_young_weight)*100,2)
q5young_mean_mizoram <- round(weighted.mean(summary_q5_young$q5_mizoram, summary_q5_young$state_young_weight)*100,2)
q5young_mean_nagaland <- round(weighted.mean(summary_q5_young$q5_nagaland, summary_q5_young$state_young_weight)*100,2)
q5young_mean_delhi <- round(weighted.mean(summary_q5_young$q5_delhi, summary_q5_young$state_young_weight)*100,2)
q5young_mean_none <- round(weighted.mean(summary_q5_young$q5_none, summary_q5_young$state_young_weight)*100,2)
q5young_mean_odisha <- round(weighted.mean(summary_q5_young$q5_odisha, summary_q5_young$state_young_weight)*100,2)
q5young_mean_puducherry <- round(weighted.mean(summary_q5_young$q5_puducherry, summary_q5_young$state_young_weight)*100,2)
q5young_mean_punjab <- round(weighted.mean(summary_q5_young$q5_punjab, summary_q5_young$state_young_weight)*100,2)
q5young_mean_rajasthan <- round(weighted.mean(summary_q5_young$q5_rajasthan, summary_q5_young$state_young_weight)*100,2)
q5young_mean_sikkim <- round(weighted.mean(summary_q5_young$q5_sikkim, summary_q5_young$state_young_weight)*100,2)
q5young_mean_tn <- round(weighted.mean(summary_q5_young$q5_tn, summary_q5_young$state_young_weight)*100,2)
q5young_mean_telangana <- round(weighted.mean(summary_q5_young$q5_telangana, summary_q5_young$state_young_weight)*100,2)
q5young_mean_tripura <- round(weighted.mean(summary_q5_young$q5_tripura, summary_q5_young$state_young_weight)*100,2)
q5young_mean_up <- round(weighted.mean(summary_q5_young$q5_up, summary_q5_young$state_young_weight)*100,2)
q5young_mean_uttarakhand <- round(weighted.mean(summary_q5_young$q5_uttarakhand, summary_q5_young$state_young_weight)*100,2)
q5young_mean_wb <- round(weighted.mean(summary_q5_young$q5_wb, summary_q5_young$state_young_weight)*100,2)
...
q5old_mean_anislands <- round(weighted.mean(summary_q5_old$q5_anislands, summary_q5_old$state_old_weight)*100,2)
q5old_mean_andhra <- round(weighted.mean(summary_q5_old$q5_andhra, summary_q5_old$state_old_weight)*100,2)
q5old_mean_arunachal <- round(weighted.mean(summary_q5_old$q5_arunachal, summary_q5_old$state_old_weight)*100,2)
q5old_mean_assam <- round(weighted.mean(summary_q5_old$q5_assam, summary_q5_old$state_old_weight)*100,2)
q5old_mean_bihar <- round(weighted.mean(summary_q5_old$q5_bihar, summary_q5_old$state_old_weight)*100,2)
q5old_mean_chandigarh <- round(weighted.mean(summary_q5_old$q5_chandigarh, summary_q5_old$state_old_weight)*100,2)
q5old_mean_chhattisgarh <- round(weighted.mean(summary_q5_old$q5_chhattisgarh, summary_q5_old$state_old_weight)*100,2)
q5old_mean_dnhdd <- round(weighted.mean(summary_q5_old$q5_dnhdd, summary_q5_old$state_old_weight)*100,2)
q5old_mean_goa <- round(weighted.mean(summary_q5_old$q5_goa, summary_q5_old$state_old_weight)*100,2)
q5old_mean_gujarat <- round(weighted.mean(summary_q5_old$q5_gujarat, summary_q5_old$state_old_weight)*100,2)
q5old_mean_haryana <- round(weighted.mean(summary_q5_old$q5_haryana, summary_q5_old$state_old_weight)*100,2)
q5old_mean_hp <- round(weighted.mean(summary_q5_old$q5_hp, summary_q5_old$state_old_weight)*100,2)
q5old_mean_jk <- round(weighted.mean(summary_q5_old$q5_jk, summary_q5_old$state_old_weight)*100,2)
q5old_mean_jharkhand <- round(weighted.mean(summary_q5_old$q5_jharkhand, summary_q5_old$state_old_weight)*100,2)
q5old_mean_karnataka <- round(weighted.mean(summary_q5_old$q5_karnataka, summary_q5_old$state_old_weight)*100,2)
q5old_mean_kerala <- round(weighted.mean(summary_q5_old$q5_kerala, summary_q5_old$state_old_weight)*100,2)
q5old_mean_ladakh <- round(weighted.mean(summary_q5_old$q5_ladakh, summary_q5_old$state_old_weight)*100,2)
q5old_mean_lakshadweep <- round(weighted.mean(summary_q5_old$q5_lakshadweep, summary_q5_old$state_old_weight)*100,2)
q5old_mean_mp <- round(weighted.mean(summary_q5_old$q5_mp, summary_q5_old$state_old_weight)*100,2)
q5old_mean_maharashtra <- round(weighted.mean(summary_q5_old$q5_maharashtra, summary_q5_old$state_old_weight)*100,2)
q5old_mean_manipur <- round(weighted.mean(summary_q5_old$q5_manipur, summary_q5_old$state_old_weight)*100,2)
q5old_mean_meghalaya <- round(weighted.mean(summary_q5_old$q5_meghalaya, summary_q5_old$state_old_weight)*100,2)
q5old_mean_mizoram <- round(weighted.mean(summary_q5_old$q5_mizoram, summary_q5_old$state_old_weight)*100,2)
q5old_mean_nagaland <- round(weighted.mean(summary_q5_old$q5_nagaland, summary_q5_old$state_old_weight)*100,2)
q5old_mean_delhi <- round(weighted.mean(summary_q5_old$q5_delhi, summary_q5_old$state_old_weight)*100,2)
q5old_mean_none <- round(weighted.mean(summary_q5_old$q5_none, summary_q5_old$state_old_weight)*100,2)
q5old_mean_odisha <- round(weighted.mean(summary_q5_old$q5_odisha, summary_q5_old$state_old_weight)*100,2)
q5old_mean_puducherry <- round(weighted.mean(summary_q5_old$q5_puducherry, summary_q5_old$state_old_weight)*100,2)
q5old_mean_punjab <- round(weighted.mean(summary_q5_old$q5_punjab, summary_q5_old$state_old_weight)*100,2)
q5old_mean_rajasthan <- round(weighted.mean(summary_q5_old$q5_rajasthan, summary_q5_old$state_old_weight)*100,2)
q5old_mean_sikkim <- round(weighted.mean(summary_q5_old$q5_sikkim, summary_q5_old$state_old_weight)*100,2)
q5old_mean_tn <- round(weighted.mean(summary_q5_old$q5_tn, summary_q5_old$state_old_weight)*100,2)
q5old_mean_telangana <- round(weighted.mean(summary_q5_old$q5_telangana, summary_q5_old$state_old_weight)*100,2)
q5old_mean_tripura <- round(weighted.mean(summary_q5_old$q5_tripura, summary_q5_old$state_old_weight)*100,2)
q5old_mean_up <- round(weighted.mean(summary_q5_old$q5_up, summary_q5_old$state_old_weight)*100,2)
q5old_mean_uttarakhand <- round(weighted.mean(summary_q5_old$q5_uttarakhand, summary_q5_old$state_old_weight)*100,2)
q5old_mean_wb <- round(weighted.mean(summary_q5_old$q5_wb, summary_q5_old$state_old_weight)*100,2)
...
```{r, echo = FALSE, fig.height=10,fig.width=18, warning=FALSE}
#Age
q6young_mean_anislands <- round(weighted.mean(summary_q6_young$q6_anislands, summary_q6_young$state_young_weight)*100,2)
q6young_mean_andhra <- round(weighted.mean(summary_q6_young$q6_andhra, summary_q6_young$state_young_weight)*100,2)
q6young_mean_arunachal <- round(weighted.mean(summary_q6_young$q6_arunachal, summary_q6_young$state_young_weight)*100,2)
q6young_mean_assam <- round(weighted.mean(summary_q6_young$q6_assam, summary_q6_young$state_young_weight)*100,2)
q6young_mean_bihar <- round(weighted.mean(summary_q6_young$q6_bihar, summary_q6_young$state_young_weight)*100,2)
q6young_mean_chandigarh <- round(weighted.mean(summary_q6_young$q6_chandigarh, summary_q6_young$state_young_weight)*100,2)
q6young_mean_chhattisgarh <- round(weighted.mean(summary_q6_young$q6_chhattisgarh, summary_q6_young$state_young_weight)*100,2)
q6young_mean_dnhdd <- round(weighted.mean(summary_q6_young$q6_dnhdd, summary_q6_young$state_young_weight)*100,2)
q6young_mean_goa <- round(weighted.mean(summary_q6_young$q6_goa, summary_q6_young$state_young_weight)*100,2)
q6young_mean_gujarat <- round(weighted.mean(summary_q6_young$q6_gujarat, summary_q6_young$state_young_weight)*100,2)
q6young_mean_haryana <- round(weighted.mean(summary_q6_young$q6_haryana, summary_q6_young$state_young_weight)*100,2)
q6young_mean_hp <- round(weighted.mean(summary_q6_young$q6_hp, summary_q6_young$state_young_weight)*100,2)
q6young_mean_jk <- round(weighted.mean(summary_q6_young$q6_jk, summary_q6_young$state_young_weight)*100,2)
q6young_mean_jharkhand <- round(weighted.mean(summary_q6_young$q6_jharkhand, summary_q6_young$state_young_weight)*100,2)
q6young_mean_karnataka <- round(weighted.mean(summary_q6_young$q6_karnataka, summary_q6_young$state_young_weight)*100,2)
q6young_mean_kerala <- round(weighted.mean(summary_q6_young$q6_kerala, summary_q6_young$state_young_weight)*100,2)
q6young_mean_ladakh <- round(weighted.mean(summary_q6_young$q6_ladakh, summary_q6_young$state_young_weight)*100,2)
q6young_mean_lakshadweep <- round(weighted.mean(summary_q6_young$q6_lakshadweep, summary_q6_young$state_young_weight)*100,2)
q6young_mean_mp <- round(weighted.mean(summary_q6_young$q6_mp, summary_q6_young$state_young_weight)*100,2)
q6young_mean_maharashtra <- round(weighted.mean(summary_q6_young$q6_maharashtra, summary_q6_young$state_young_weight)*100,2)
q6young_mean_manipur <- round(weighted.mean(summary_q6_young$q6_manipur, summary_q6_young$state_young_weight)*100,2)
q6young_mean_meghalaya <- round(weighted.mean(summary_q6_young$q6_meghalaya, summary_q6_young$state_young_weight)*100,2)
q6young_mean_mizoram <- round(weighted.mean(summary_q6_young$q6_mizoram, summary_q6_young$state_young_weight)*100,2)
q6young_mean_nagaland <- round(weighted.mean(summary_q6_young$q6_nagaland, summary_q6_young$state_young_weight)*100,2)
q6young_mean_delhi <- round(weighted.mean(summary_q6_young$q6_delhi, summary_q6_young$state_young_weight)*100,2)
q6young_mean_none <- round(weighted.mean(summary_q6_young$q6_none, summary_q6_young$state_young_weight)*100,2)
q6young_mean_odisha <- round(weighted.mean(summary_q6_young$q6_odisha, summary_q6_young$state_young_weight)*100,2)
q6young_mean_puducherry <- round(weighted.mean(summary_q6_young$q6_puducherry, summary_q6_young$state_young_weight)*100,2)
q6young_mean_punjab <- round(weighted.mean(summary_q6_young$q6_punjab, summary_q6_young$state_young_weight)*100,2)
q6young_mean_rajasthan <- round(weighted.mean(summary_q6_young$q6_rajasthan, summary_q6_young$state_young_weight)*100,2)
q6young_mean_sikkim <- round(weighted.mean(summary_q6_young$q6_sikkim, summary_q6_young$state_young_weight)*100,2)
q6young_mean_tn <- round(weighted.mean(summary_q6_young$q6_tn, summary_q6_young$state_young_weight)*100,2)
q6young_mean_telangana <- round(weighted.mean(summary_q6_young$q6_telangana, summary_q6_young$state_young_weight)*100,2)
q6young_mean_tripura <- round(weighted.mean(summary_q6_young$q6_tripura, summary_q6_young$state_young_weight)*100,2)
q6young_mean_up <- round(weighted.mean(summary_q6_young$q6_up, summary_q6_young$state_young_weight)*100,2)
q6young_mean_uttarakhand <- round(weighted.mean(summary_q6_young$q6_uttarakhand, summary_q6_young$state_young_weight)*100,2)
q6young_mean_wb <- round(weighted.mean(summary_q6_young$q6_wb, summary_q6_young$state_young_weight)*100,2)
...
q6old_mean_anislands <- round(weighted.mean(summary_q6_old$q6_anislands, summary_q6_old$state_old_weight)*100,2)
q6old_mean_andhra <- round(weighted.mean(summary_q6_old$q6_andhra, summary_q6_old$state_old_weight)*100,2)
q6old_mean_arunachal <- round(weighted.mean(summary_q6_old$q6_arunachal, summary_q6_old$state_old_weight)*100,2)
q6old_mean_assam <- round(weighted.mean(summary_q6_old$q6_assam, summary_q6_old$state_old_weight)*100,2)
q6old_mean_bihar <- round(weighted.mean(summary_q6_old$q6_bihar, summary_q6_old$state_old_weight)*100,2)
q6old_mean_chandigarh <- round(weighted.mean(summary_q6_old$q6_chandigarh, summary_q6_old$state_old_weight)*100,2)
q6old_mean_chhattisgarh <- round(weighted.mean(summary_q6_old$q6_chhattisgarh, summary_q6_old$state_old_weight)*100,2)
q6old_mean_dnhdd <- round(weighted.mean(summary_q6_old$q6_dnhdd, summary_q6_old$state_old_weight)*100,2)
q6old_mean_goa <- round(weighted.mean(summary_q6_old$q6_goa, summary_q6_old$state_old_weight)*100,2)
q6old_mean_gujarat <- round(weighted.mean(summary_q6_old$q6_gujarat, summary_q6_old$state_old_weight)*100,2)
q6old_mean_haryana <- round(weighted.mean(summary_q6_old$q6_haryana, summary_q6_old$state_old_weight)*100,2)
q6old_mean_hp <- round(weighted.mean(summary_q6_old$q6_hp, summary_q6_old$state_old_weight)*100,2)
q6old_mean_jk <- round(weighted.mean(summary_q6_old$q6_jk, summary_q6_old$state_old_weight)*100,2)
q6old_mean_jharkhand <- round(weighted.mean(summary_q6_old$q6_jharkhand, summary_q6_old$state_old_weight)*100,2)
q6old_mean_karnataka <- round(weighted.mean(summary_q6_old$q6_karnataka, summary_q6_old$state_old_weight)*100,2)
q6old_mean_kerala <- round(weighted.mean(summary_q6_old$q6_kerala, summary_q6_old$state_old_weight)*100,2)
q6old_mean_ladakh <- round(weighted.mean(summary_q6_old$q6_ladakh, summary_q6_old$state_old_weight)*100,2)
q6old_mean_lakshadweep <- round(weighted.mean(summary_q6_old$q6_lakshadweep, summary_q6_old$state_old_weight)*100,2)
q6old_mean_mp <- round(weighted.mean(summary_q6_old$q6_mp, summary_q6_old$state_old_weight)*100,2)
q6old_mean_maharashtra <- round(weighted.mean(summary_q6_old$q6_maharashtra, summary_q6_old$state_old_weight)*100,2)
q6old_mean_manipur <- round(weighted.mean(summary_q6_old$q6_manipur, summary_q6_old$state_old_weight)*100,2)
q6old_mean_meghalaya <- round(weighted.mean(summary_q6_old$q6_meghalaya, summary_q6_old$state_old_weight)*100,2)
q6old_mean_mizoram <- round(weighted.mean(summary_q6_old$q6_mizoram, summary_q6_old$state_old_weight)*100,2)
q6old_mean_nagaland <- round(weighted.mean(summary_q6_old$q6_nagaland, summary_q6_old$state_old_weight)*100,2)
q6old_mean_delhi <- round(weighted.mean(summary_q6_old$q6_delhi, summary_q6_old$state_old_weight)*100,2)
q6old_mean_none <- round(weighted.mean(summary_q6_old$q6_none, summary_q6_old$state_old_weight)*100,2)
q6old_mean_odisha <- round(weighted.mean(summary_q6_old$q6_odisha, summary_q6_old$state_old_weight)*100,2)
q6old_mean_puducherry <- round(weighted.mean(summary_q6_old$q6_puducherry, summary_q6_old$state_old_weight)*100,2)
q6old_mean_punjab <- round(weighted.mean(summary_q6_old$q6_punjab, summary_q6_old$state_old_weight)*100,2)
q6old_mean_rajasthan <- round(weighted.mean(summary_q6_old$q6_rajasthan, summary_q6_old$state_old_weight)*100,2)
q6old_mean_sikkim <- round(weighted.mean(summary_q6_old$q6_sikkim, summary_q6_old$state_old_weight)*100,2)
q6old_mean_tn <- round(weighted.mean(summary_q6_old$q6_tn, summary_q6_old$state_old_weight)*100,2)
q6old_mean_telangana <- round(weighted.mean(summary_q6_old$q6_telangana, summary_q6_old$state_old_weight)*100,2)
q6old_mean_tripura <- round(weighted.mean(summary_q6_old$q6_tripura, summary_q6_old$state_old_weight)*100,2)
q6old_mean_up <- round(weighted.mean(summary_q6_old$q6_up, summary_q6_old$state_old_weight)*100,2)
q6old_mean_uttarakhand <- round(weighted.mean(summary_q6_old$q6_uttarakhand, summary_q6_old$state_old_weight)*100,2)
q6old_mean_wb <- round(weighted.mean(summary_q6_old$q6_wb, summary_q6_old$state_old_weight)*100,2)
...
```{r echo = FALSE, fig.height=10,fig.width=18}
#Age 
q7young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X130ones, summary_state_analysis_young$state_young_weight)*100,2) 
q7young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X130twos, summary_state_analysis_young$state_young_weight)*100,2)
...
q7old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X130ones, summary_state_analysis_old$state_old_weight)*100,2) 
q7old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X130twos, summary_state_analysis_old$state_old_weight)*100,2)
...
plot7_fullage <- plot_grid(plot7_fullage, legend7, nrow = 2, rel_heights=c(5,1)) 
plot7_fullage
```
\newpage
...
q7aspt_plot <- ggplot(q7aspt_plot_dta, aes(x=q7full_plot_labels, y=q7aspt_plot, fill = q7full_plot_labels)) +
  geom_bar(stat="identity", width= 0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q7aspt_plot),"%"), vjust=-0.3), size=7) +
  scale_y_continuous(limits = c(0,100)) +  
  scale_x_discrete(labels= c("","")) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", title = "Aspirant States") +
...
q7perf_plot <- ggplot(q7perf_plot_dta, aes(x=q7full_plot_labels, y=q7perf_plot, fill = q7full_plot_labels)) +
  geom_bar(stat="identity", width= 0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q7perf_plot),"%"), vjust=-0.3), size=7) +
  scale_y_continuous(limits = c(0,100)) +  
  scale_x_discrete(labels= c("","")) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", title = "Performer States") +
...
q7frnt_plot_temp <- ggplot(q7frnt_plot_dta, aes(x=q7full_plot_labels, y=q7frnt_plot, fill = q7full_plot_labels)) +
  geom_bar(stat="identity", width= 0.5, show.legend = TRUE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q7frnt_plot),"%"), vjust=-0.3), size=7) +
  scale_y_continuous(limits = c(0,100)) +  
  scale_x_discrete(labels= c("","")) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", title = "Frontrunner States") +
...
q7_fullsdg <- plot_grid(q7_fullsdg,legend7, nrow = 2, rel_heights=c(5,1))
...
```{r echo = FALSE, fig.height=10,fig.width=18}
#Age
q8young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X131ones, summary_state_analysis_young$state_young_weight)*100,2) 
q8young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X131twos, summary_state_analysis_young$state_young_weight)*100,2)
q8young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X131threes, summary_state_analysis_young$state_young_weight)*100,2)
q8young_mean_fours <- round(weighted.mean(summary_state_analysis_young$X131fours, summary_state_analysis_young$state_young_weight)*100,2)
...
q8old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X131ones, summary_state_analysis_old$state_old_weight)*100,2) 
q8old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X131twos, summary_state_analysis_old$state_old_weight)*100,2)
q8old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X131threes, summary_state_analysis_old$state_old_weight)*100,2)
q8old_mean_fours <- round(weighted.mean(summary_state_analysis_old$X131fours, summary_state_analysis_old$state_old_weight)*100,2)
...
plot8_fullage <- plot_grid(plot8_fullage, legend8, nrow = 2, rel_heights=c(5,1)) 
plot8_fullage
```
\newpage
...
q8aspt_plot <- ggplot(q8aspt_plot_dta, aes(x=q8full_plot_labels, y=q8aspt_plot, fill = q8full_plot_labels)) +
  geom_bar(stat="identity", width=0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q8aspt_plot),"%"), vjust=-0.3), size=6) +
  scale_y_continuous(limits = c(0,100))  +
  labs(x="",y="Percent")  +
  scale_x_discrete(labels= c("","","","","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q8perf_plot <- ggplot(q8perf_plot_dta, aes(x=q8full_plot_labels, y=q8perf_plot, fill = q8full_plot_labels)) +
  geom_bar(stat="identity", width=0.5, show.legend = FALSE) + 
  geom_text(aes(label=paste0(sprintf("%0.2f", q8perf_plot),"%"), vjust=-0.3), size=6) +
  scale_y_continuous(limits = c(0,100)) +
  labs(x="",y="Percent") +
  scale_x_discrete(labels= c("","","","","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q8frnt_plot_temp <- ggplot(q8frnt_plot_dta, aes(x=q8full_plot_labels, y=q8frnt_plot, fill = q8full_plot_labels)) +
  geom_bar(stat="identity", width=0.5, show.legend = TRUE) + 
  geom_text(aes(label=scales::percent(q8frnt_plot/100)), vjust=-0.3, size=6) +
  scale_y_continuous(limits = c(0,100)) +
  labs(x="",y="Percent") +
  scale_x_discrete(labels= c("","","","","")) +
  scale_fill_brewer(palette="YlGnBu") +
...
q8_fullsdg <- plot_grid(q8_fullsdg,legend8, nrow = 2, rel_heights=c(5,1))
...
```{r echo = FALSE, fig.height=10,fig.width=18}
#Age
q9young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X132ones, summary_state_analysis_young$state_young_weight)*100,2) 
q9young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X132twos, summary_state_analysis_young$state_young_weight)*100,2)
...
q9old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X132ones, summary_state_analysis_old$state_old_weight)*100,2) 
q9old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X132twos, summary_state_analysis_old$state_old_weight)*100,2)
...
q9_former_plotlabels <- c("Given the lack of consensus in our democracy, any other course of action would have resulted in unnecessary chaos and confusion among \n  the public.","Transparency and greater consultation in policy making could have secured more positive results in terms of greater trust and cooperation \n from the public.")
...
plot9_fullage <- plot_grid(plot9_fullage, legend9, nrow = 2, rel_heights=c(5,1)) 
plot9_fullage
```
\newpage
...
q9full_plot_labels <- c("Given the lack of consensus in our democracy, any other course of action would have resulted in unnecessary chaos and confusion among \n  the public.","Transparency and greater consultation in policy making could have secured more positive results in terms of greater trust and cooperation \n from the public.")
...
q9_fullsdg <- plot_grid(q9_fullsdg,legend9, nrow = 2, rel_heights=c(5,1))
...
\vspace{6mm}
```{r echo = FALSE, fig.height=10,fig.width=18}
q10young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X133ones, summary_state_analysis_young$state_young_weight)*100,2) 
q10young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X133twos, summary_state_analysis_young$state_young_weight)*100,2)
q10young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X133threes, summary_state_analysis_young$state_young_weight)*100,2)
...
q10old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X133ones, summary_state_analysis_old$state_old_weight)*100,2) 
q10old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X133twos, summary_state_analysis_old$state_old_weight)*100,2)
q10old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X133threes, summary_state_analysis_old$state_old_weight)*100,2)
...
q10_former_plotlabels <- c("During the pandemic, policy has exhibited a rational response to changing evidence and information about the pandemic.","Even though the pandemic posed unique challenges, policy making could still be characterised as ad hoc, responding to political \n imperatives, public pressure and judicial pronouncements.","In the pandemic context policy making has followed a natural and inevitable course given the diverse, federal nature \n of our country.")
...
plot10_fullage <- plot_grid(plot10_fullage, legend10, nrow = 2, rel_heights=c(5,1)) 
plot10_fullage
```
\newpage
...
q10full_plot_labels <- c("During the pandemic, policy has exhibited a rational response to changing evidence and information about the pandemic.","Even though the pandemic posed unique challenges, policy making could still be characterised as ad hoc, responding to political \n imperatives, public pressure and judicial pronouncements.","In the pandemic context policy making has followed a natural and inevitable course given the diverse, federal nature \n of our country.")
...
q10_fullsdg <- plot_grid(q10_fullsdg,legend10, nrow = 2, rel_heights=c(5,1))
...
```{r echo = FALSE, fig.height=10,fig.width=18}
#Age
q11young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X134ones, summary_state_analysis_young$state_young_weight)*100,2) 
q11young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X134twos, summary_state_analysis_young$state_young_weight)*100,2)
q11young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X134threes, summary_state_analysis_young$state_young_weight)*100,2)
q11young_mean_fours <- round(weighted.mean(summary_state_analysis_young$X134fours, summary_state_analysis_young$state_young_weight)*100,2)
...
q11old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X134ones, summary_state_analysis_old$state_old_weight)*100,2) 
q11old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X134twos, summary_state_analysis_old$state_old_weight)*100,2)
q11old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X134threes, summary_state_analysis_old$state_old_weight)*100,2)
q11old_mean_fours <- round(weighted.mean(summary_state_analysis_old$X134fours, summary_state_analysis_old$state_old_weight)*100,2)
...
plot11_fullage <- plot_grid(plot11_fullage, legend11, nrow = 2, rel_heights=c(5,1)) 
plot11_fullage
```
\newpage
...
q11_fullsdg <- plot_grid(q11_fullsdg,legend11, nrow = 2, rel_heights=c(5,1))
...
\vspace{6mm}
```{r echo = FALSE, fig.height=10,fig.width=18}
q12young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X135ones, summary_state_analysis_young$state_young_weight)*100,2) 
q12young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X135twos, summary_state_analysis_young$state_young_weight)*100,2)
q12young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X135threes, summary_state_analysis_young$state_young_weight)*100,2)
q12young_mean_fours <- round(weighted.mean(summary_state_analysis_young$X135fours, summary_state_analysis_young$state_young_weight)*100,2)
...
q12old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X135ones, summary_state_analysis_old$state_old_weight)*100,2) 
q12old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X135twos, summary_state_analysis_old$state_old_weight)*100,2)
q12old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X135threes, summary_state_analysis_old$state_old_weight)*100,2)
q12old_mean_fours <- round(weighted.mean(summary_state_analysis_old$X135fours, summary_state_analysis_old$state_old_weight)*100,2)
...
plot12_fullage <- plot_grid(plot12_fullage, legend12, nrow = 2, rel_heights=c(5,1)) 
plot12_fullage
```
\newpage
...
q12_fullsdg <- plot_grid(q12_fullsdg,legend12, nrow = 2, rel_heights=c(5,1))
...
\vspace{6mm}
```{r echo = FALSE, fig.height=10,fig.width=18}
q14young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X137ones, summary_state_analysis_young$state_young_weight)*100,2) 
q14young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X137twos, summary_state_analysis_young$state_young_weight)*100,2)
q14young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X137threes, summary_state_analysis_young$state_young_weight)*100,2)
q14young_mean_fours <- round(weighted.mean(summary_state_analysis_young$X137fours, summary_state_analysis_young$state_young_weight)*100,2)
...
q14old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X137ones, summary_state_analysis_old$state_old_weight)*100,2) 
q14old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X137twos, summary_state_analysis_old$state_old_weight)*100,2)
q14old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X137threes, summary_state_analysis_old$state_old_weight)*100,2)
q14old_mean_fours <- round(weighted.mean(summary_state_analysis_old$X137fours, summary_state_analysis_old$state_old_weight)*100,2)
...
plot14_fullage <- plot_grid(plot14_fullage, legend14, nrow = 2, rel_heights=c(5,1)) 
plot14_fullage
```
\newpage
...
q14_fullsdg <- plot_grid(q14_fullsdg,legend14, nrow = 2, rel_heights=c(5,1))
...
\vspace{6mm}
```{r echo = FALSE, fig.height=10,fig.width=18}
q15young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X138ones, summary_state_analysis_young$state_young_weight)*100,2) 
q15young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X138twos, summary_state_analysis_young$state_young_weight)*100,2)
q15young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X138threes, summary_state_analysis_young$state_young_weight)*100,2)
q15young_mean_fours <- round(weighted.mean(summary_state_analysis_young$X138fours, summary_state_analysis_young$state_young_weight)*100,2)
...
q15old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X138ones, summary_state_analysis_old$state_old_weight)*100,2) 
q15old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X138twos, summary_state_analysis_old$state_old_weight)*100,2)
q15old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X138threes, summary_state_analysis_old$state_old_weight)*100,2)
q15old_mean_fours <- round(weighted.mean(summary_state_analysis_old$X138fours, summary_state_analysis_old$state_old_weight)*100,2)
...
plot15_fullage <- plot_grid(plot15_fullage, legend15, nrow = 2, rel_heights=c(5,1)) 
plot15_fullage
```
\newpage
...
q15_fullsdg <- plot_grid(q15_fullsdg,legend15, nrow = 2, rel_heights=c(5,1))
...
\vspace{6mm}
```{r echo = FALSE, fig.height=10,fig.width=18}
q16young_mean_ones <- round(weighted.mean(summary_state_analysis_young$X139ones, summary_state_analysis_young$state_young_weight)*100,2) 
q16young_mean_twos <- round(weighted.mean(summary_state_analysis_young$X139twos, summary_state_analysis_young$state_young_weight)*100,2)
q16young_mean_threes <- round(weighted.mean(summary_state_analysis_young$X139threes, summary_state_analysis_young$state_young_weight)*100,2)
...
q16old_mean_ones <- round(weighted.mean(summary_state_analysis_old$X139ones, summary_state_analysis_old$state_old_weight)*100,2) 
q16old_mean_twos <- round(weighted.mean(summary_state_analysis_old$X139twos, summary_state_analysis_old$state_old_weight)*100,2)
q16old_mean_threes <- round(weighted.mean(summary_state_analysis_old$X139threes, summary_state_analysis_old$state_old_weight)*100,2)
...
plot16_fullage <- plot_grid(plot16_fullage, legend16, nrow = 2, rel_heights=c(5,1)) 
plot16_fullage
```
\newpage
...
q16_fullsdg <- plot_grid(q16_fullsdg,legend16, nrow = 2, rel_heights=c(5,1))
