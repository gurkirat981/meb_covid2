...
q4full_mean_chhattisgarh <- round(weighted.mean(summary_q4$q4_chhattisgarh, summary_q4$state_weight)*100,3)
...
q5full_mean_chhattisgarh <- round(weighted.mean(summary_q5$q5_chhattisgarh, summary_q5$state_weight)*100,3)
...
q6full_mean_chhattisgarh <- round(weighted.mean(summary_q6$q6_chhattisgarh, summary_q6$state_weight)*100,3)
