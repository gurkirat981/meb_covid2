...
```{r}
##Gurkirat##
q3full_mean_ones <- round(mean(summary_state_analysis$X18ones)*100,3) 
...
q7full_mean_ones <- round(mean(summary_state_analysis$X130ones)*100,2) 
...
```{r}
##Gurkirat##
q8full_mean_ones <- round(mean(summary_state_analysis$X131ones)*100,3) 
...
q9full_mean_ones <- round(mean(summary_state_analysis$X132ones)*100,2) 
...
```{r}
##Gurkirat##
q10full_mean_ones <- round(mean(summary_state_analysis$X133ones)*100,3) 
...
```{r}
##Gurkirat##
q11full_mean_ones <- round(mean(summary_state_analysis$X134ones)*100,3) 
q11full_mean_twos <- round(mean(summary_state_analysis$X134twos)*100,3) 
q11full_mean_threes <- round(mean(summary_state_analysis$X134threes)*100,3)
q11full_mean_fours <- round(mean(summary_state_analysis$X134fours)*100,3)
...
q11full_plot <- ggplot(q11full_plot_dta, aes(x=q11full_plot_labels, y=q11full_plot, fill = q11full_plot_labels)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 11") +
  newtheme
...
```{r}
##Gurkirat##
q12full_mean_ones <- round(mean(summary_state_analysis$X135ones)*100,3) 
q12full_mean_twos <- round(mean(summary_state_analysis$X135twos)*100,3) 
q12full_mean_threes <- round(mean(summary_state_analysis$X135threes)*100,3)
q12full_mean_fours <- round(mean(summary_state_analysis$X135fours)*100,3)
...
q12full_plot <- ggplot(q12full_plot_dta, aes(x=q12full_plot_labels, y=q12full_plot, fill = q12full_plot_labels)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 12") +
  newtheme
...
```{r}
##Gurkirat##
q14full_mean_ones <- round(mean(summary_state_analysis$X137ones)*100,3) 
q14full_mean_twos <- round(mean(summary_state_analysis$X137twos)*100,3) 
q14full_mean_threes <- round(mean(summary_state_analysis$X137threes)*100,3)
q14full_mean_fours <- round(mean(summary_state_analysis$X137fours)*100,3)
...
q14full_plot <- ggplot(q14full_plot_dta, aes(x=q14full_plot_labels, y=q14full_plot, fill = q14full_plot_labels)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 14") +
  newtheme
