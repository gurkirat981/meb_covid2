...
summary_q5_unbiased_unweighted <- state_answers_q5_unbiased %>% 
  na.omit() %>% 
  summarise(q5_anislands=sum(Merged =="Andaman and Nicobar Islands")/length(Merged),
            q5_andhra=sum(Merged =="Andhra Pradesh")/length(Merged), 
            q5_arunachal=sum(Merged =="Arunachal Pradesh")/length(Merged),
...
summary_q5_unbiased_unweighted<-as.data.frame(t(summary_q5_unbiased_unweighted)) %>%
  mutate(V1=round(V1*100, digits=2)) %>% 
  arrange(desc(V1))
...
b_nw <- cbind (summary_q4_unweighted, summary_q5_nonweighted, summary_q6_nonweighted)
...
write.table (summary_nr_q4_unweighted, "/Users/gurkirat/Documents/GitHub/ias-release/q4_unbiased_unweighted.txt", sep = "\t")
write.table (summary_q5_unbiased_unweighted, "/Users/gurkirat/Documents/GitHub/ias-release/q5_unbiased_unweighted.txt", sep = "\t")
write.table (summary_q6_unbiased, "/Users/gurkirat/Documents/GitHub/ias-release/q6_unbiased_unweighted.txt", sep = "\t")
write.table (b_nw, "/Users/gurkirat/Documents/GitHub/ias-release/b_nw.txt", sep = "\t")
```
\newpage
