...
summary_q4_unweighted <- state_answers_q4 %>% 
  summarise(Anislands= round(sum(Merged =="Andaman and Nicobar Islands")*100/length(Merged),2),
            AndhraPradesh=round(sum(Merged =="Andhra Pradesh")*100/length(Merged),2), 
            ArunachalPradesh=round(sum(Merged =="Arunachal Pradesh")*100/length(Merged),2),
            ...
            HimachalPradesh=round(sum(Merged =="Himachal Pradesh")*100/length(Merged),2),
            JammuKashmir=round(sum(Merged =="Jammu and Kashmir")*100/length(Merged),2),
            ...
            LakshadweepIslands=round(sum(Merged =="Lakshadweep")*100/length(Merged),2),
            MadhyaPradesh=round(sum(Merged =="Madhya Pradesh")*100/length(Merged),2),
            ...
            TamilNadu=round(sum(Merged =="Tamil Nadu")*100/length(Merged),2),
            Telangana=round(sum(Merged =="Telangana")*100/length(Merged),2),
            Tripura=round(sum(Merged =="Tripura")*100/length(Merged),2),
            UttarPradesh=round(sum(Merged =="Uttar Pradesh")*100/length(Merged),2),
            Uttarakhand=round(sum(Merged =="Uttarakhand")*100/length(Merged),2),
            WestBengal=round(sum(Merged =="West Bengal")*100/length(Merged),2)) %>% 
  ungroup() 
...
summary_nr_q4_unweighted <- nr_q4 %>% 
 ...
 summarise(Anislands= round(sum(Merged =="Andaman and Nicobar Islands")*100/length(Merged),2),
          ...
          DNHDD=round(sum(Merged =="Dadra and Nagar Haveli and Daman and Dui")*100/length(Merged),2),
          Goa=round(sum(Merged =="Goa")*100/length(Merged),2),
          Gujrat=round(sum(Merged =="Gujarat")*100/length(Merged),2),
          Haryana=round(sum(Merged =="Haryana")*100/length(Merged),2),
          HimachalPradesh=round(sum(Merged =="Himachal Pradesh")*100/length(Merged),2),
          JammuKashmir=round(sum(Merged =="Jammu and Kashmir")*100/length(Merged),2),
          Jharkhand=round(sum(Merged =="Jharkhand")*100/length(Merged),2),
...
# #Merging averages for cumulative and biased responses in a single table/data-frame
# row.names(summary_q4_unweighted) <- LETTERS[1:1]
# summary_q4_unweighted <- as.data.frame(t(summary_q4_unweighted)) %>% 
# rename ("Percentage of Responses-Cumulative (Best State)" = A)
# 
# row.names(summary_nr_q4_unweighted) <- LETTERS[1:1]
# summary_nr_q4_unweighted <- as.data.frame(t(summary_nr_q4_unweighted)) %>% 
# rename ("Percentage of Responses-Unbiased (Best State)" = A )
# 
# q4_unweighted <- cbind (summary_q4_unweighted, summary_nr_q4_unweighted)

#Merging averages for cumulative and biased responses in a single table/data-frame
row.names(summary_q4_unweighted) <- LETTERS[1:1]
summary_q4_unweighted <- as.data.frame(t(summary_q4_unweighted)) %>% 
rename ("Responses-Cumulative" = A)

row.names(summary_nr_q4_unweighted) <- LETTERS[1:1]
summary_nr_q4_unweighted <- as.data.frame(t(summary_nr_q4_unweighted)) %>% 
rename ("Responses-Unbiased" = A )

q4_unweighted <- cbind (summary_q4_unweighted, summary_nr_q4_unweighted)

q4_unweighted %>%
  kbl(caption = "Officer responses for Best State") %>%
...
state_responses<-setNames(cbind(rownames(state_responses), state_responses, row.names = NULL), 
         c("state", "Q4 Proportion of All Responses", "Q4 Proportion of Unbiased Responses", "Q5 Proportion of All Responses", "Q5 Proportion of Unbiased Responses",  "Q6 Proportion of All Responses", "Q6 Proportion of Unbiased Responses"))
```
\newpage
