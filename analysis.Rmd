...
processed_dta<-raw_dta[-c(1,2),-c(2, 5:9,15,140,141)]%>% #might want to mark later which columns we are removing
...
Example graph I: Question 1, X16 (binary answers)
...
```{r}
##Gurkirat##
#Example graph for question 1. I have used Arithmetic Mean instead of Weighted Mean.
q1full_mean_ones <- round(mean(summary_state_analysis$X16ones)*100,2) #consider doing rounding and mean estimation at an earlier stage for all questions.
q1full_mean_twos <- round(mean(summary_state_analysis$X16twos)*100,2)
...
q1full_plot <- ggplot(q1full_plot_dta, aes(x=q1full_plot_labels, y=q1full_plot, fill = q1full_plot_labels)) +
  ...
  labs(x="",y="Percent", caption= "Question 1") +
  newtheme
...
Example graph II: Question 15, X138 (4 responses)
...
```{r}
##Gurkirat##
#Example graph for question 15. I have used Arithmetic Mean instead of Weighted Mean.

q15full_mean_ones <- round(mean(summary_state_analysis$X138ones)*100,3) #consider doing rounding and mean estimation at an earlier stage for all questions.
q15full_mean_twos <- round(mean(summary_state_analysis$X138twos)*100,3) 
q15full_mean_threes <- round(mean(summary_state_analysis$X138threes)*100,3)
q15full_mean_fours <- round(mean(summary_state_analysis$X138fours)*100,3)
...
q15full_plot <- ggplot(q15full_plot_dta, aes(x=q15full_plot_labels, y=q15full_plot, fill = q15full_plot_labels)) +
  ...
  scale_y_continuous(limits = c(0,100)) +  
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption= "Question 15") +
  newtheme
...
#Shubhangi says: this is already in the IAS distribution code under a different variable name, check and change the variable name in the following code! 
#differing rows error:b need to get the alternate code reviewed before pushing changes.
...
Example graph III: Question 7, X130 (4 binary answers)
...
```{r}
##Gurkirat##
#I have continued to use arthimatic mean as it will be better to get weights reviewed and collectively verified once before pushing them on the graph code.

q7full_mean_ones <- round(mean(summary_state_analysis$X130ones)*100,2) #consider doing rounding and mean estimation at an earlier stage for all questions.
q7full_mean_twos <- round(mean(summary_state_analysis$X130twos)*100,2)
...
q7full_plot <- ggplot(q7full_plot_dta, aes(x=q7full_plot_labels, y=q7full_plot, fill = q7full_plot_labels)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption= "Question 7") +
  newtheme
...
```
Example graph IV: Question 3, X18 (4 responses)
...
```{r}
##Gurkirat##
q3full_mean_ones <- round(mean(summary_state_analysis$X18ones)*100,3) #consider doing rounding and mean estimation at an earlier stage for all questions.
q3full_mean_twos <- round(mean(summary_state_analysis$X18twos)*100,3) 
q3full_mean_threes <- round(mean(summary_state_analysis$X18threes)*100,3)
q3full_mean_fours <- round(mean(summary_state_analysis$X18fours)*100,3)
...
q3full_plot <- ggplot(q3full_plot_dta, aes(x=q3full_plot_labels, y=q3full_plot, fill = q3full_plot_labels)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 3") +
  newtheme
...
##Gurkirat##
```
Example graph V: Question 8, X131 (Binary answers)
...
```{r}
##Gurkirat##
q8full_mean_ones <- round(mean(summary_state_analysis$X131ones)*100,3) #consider doing rounding and mean estimation at an earlier stage for all questions.
q8full_mean_twos <- round(mean(summary_state_analysis$X131twos)*100,3) 
q8full_mean_threes <- round(mean(summary_state_analysis$X131threes)*100,3)
q8full_mean_fours <- round(mean(summary_state_analysis$X131fours)*100,3)
...
q8full_plot <- ggplot(q8full_plot_dta, aes(x=q8full_plot_labels, y=q8full_plot, fill = q8full_plot_labels)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 8") +
  newtheme
...
Example graph VI: Question 9, X132 (4 responses)
...
q9full_mean_ones <- round(mean(summary_state_analysis$X132ones)*100,2) #consider doing rounding and mean estimation at an earlier stage for all questions.
q9full_mean_twos <- round(mean(summary_state_analysis$X132twos)*100,2)
...
q9full_plot <- ggplot(q9full_plot_dta, aes(x=q9full_plot_labels, y=q9full_plot, fill = q9full_plot_labels)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption= "Question 9") +
  newtheme
...
Example graph VII: Question 10, X133 (3 responses)
...
```{r}
##Gurkirat##
q10full_mean_ones <- round(mean(summary_state_analysis$X133ones)*100,3) #consider doing rounding and mean estimation at an earlier stage for all questions.
q10full_mean_twos <- round(mean(summary_state_analysis$X133twos)*100,3) 
q10full_mean_threes <- round(mean(summary_state_analysis$X133threes)*100,3)
...
q10full_plot <- ggplot(q10full_plot_dta, aes(x=q10full_plot_labels, y=q10full_plot, fill = q10full_plot_labels)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 10") +
  newtheme
...
##Gurkirat##
```
>>>>>>> 2291a0c55985546b013b744528544254accbd300
