...
state_answers_q4_old <- fullage_old %>% 
  ...
  mutate (Merged = Merged1.2) %>% 
  dplyr:: select (-Merged1.2) %>% 
  add_row(q4_state_answers1_old, X12) 
...
241 officers (out of 452) felt that their own state has been best at executing their pandemic management responsibilities. These officers may be biased in their response. The following graph excludes all biased responses for question 4.
