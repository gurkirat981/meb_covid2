...
summary_state_age<-full_serving %>% 
  ...
  group_by(state) %>% 
  summarise(X16ones_young=sum(X16[age=="2011 and before"]==1)/length(state), X16twos_young=sum(X16[age=="2011 and before"]==2)/length(state),
            X16ones_old=sum(X16[age=="2012 and after"]==1)/length(state), X16twos_old=sum(X16[age=="2012 and after"]==2)/length(state),
            X17ones_young=sum(X17[age=="2011 and before"]==1)/length(state), X17twos_young=sum(X17[age=="2011 and before"]==2)/length(state), X17threes_young=sum(X17[age=="2011 and before"]==3)/length(state), X17fours_young=sum(X17[age=="2011 and before"]==4)/length(state),
            X17ones_old=sum(X17[age=="2012 and after"]==1)/length(state), X17twos_old=sum(X17[age=="2012 and after"]==2)/length(state), X17threes_old=sum(X17[age=="2012 and after"]==3)/length(state), X17fours_old=sum(X17[age=="2012 and after"]==4)/length(state),
            X18ones_young=sum(X18[age=="2011 and before"]==1)/length(state), X18twos_young=sum(X18[age=="2011 and before"]==2)/length(state), X18threes_young=sum(X18[age=="2011 and before"]==3)/length(state), X18fours_young=sum(X18[age=="2011 and before"]==4)/length(state),
            X18ones_old=sum(X18[age=="2012 and after"]==1)/length(state), X18twos_old=sum(X18[age=="2012 and after"]==2)/length(state), X18threes_old=sum(X18[age=="2012 and after"]==3)/length(state), X18fours_old=sum(X18[age=="2012 and after"]==4)/length(state),
            X130ones_young=sum(X130[age=="2011 and before"]==1)/length(state), X130twos_young=sum(X130[age=="2011 and before"]==2)/length(state),
            X130ones_old=sum(X130[age=="2012 and after"]==1)/length(state), X130twos_old=sum(X130[age=="2012 and after"]==2)/length(state),
            X131ones_young=sum(X131[age=="2011 and before"]==1)/length(state), X131twos_young=sum(X131[age=="2011 and before"]==2)/length(state), X131threes_young=sum(X131[age=="2011 and before"]==3)/length(state), X131fours_young=sum(X131[age=="2011 and before"]==4)/length(state),
            X131ones_old=sum(X131[age=="2012 and after"]==1)/length(state), X131twos_old=sum(X131[age=="2012 and after"]==2)/length(state), X131threes_old=sum(X131[age=="2012 and after"]==3)/length(state), X131fours_old=sum(X131[age=="2012 and after"]==4)/length(state),
            X132ones_young=sum(X132[age=="2011 and before"]==1)/length(state), X132twos_young=sum(X132[age=="2011 and before"]==2)/length(state),
            X132ones_old=sum(X132[age=="2012 and after"]==1)/length(state), X132twos_old=sum(X132[age=="2012 and after"]==2)/length(state),
            X133ones_young=sum(X133[age=="2011 and before"]==1)/length(state), X133twos_young=sum(X133[age=="2011 and before"]==2)/length(state), X133threes_young=sum(X133[age=="2011 and before"]==3)/length(state),
            X133ones_old=sum(X133[age=="2012 and after"]==1)/length(state), X133twos_old=sum(X133[age=="2012 and after"]==2)/length(state), X133threes_old=sum(X133[age=="2012 and after"]==3)/length(state),
            X134ones_young=sum(X134[age=="2011 and before"]==1)/length(state), X134twos_young=sum(X134[age=="2011 and before"]==2)/length(state), X134threes_young=sum(X134[age=="2011 and before"]==3)/length(state), X134fours_young=sum(X134[age=="2011 and before"]==4)/length(state),
            X134ones_old=sum(X134[age=="2012 and after"]==1)/length(state), X134twos_old=sum(X134[age=="2012 and after"]==2)/length(state), X134threes_old=sum(X134[age=="2012 and after"]==3)/length(state), X134fours_old=sum(X134[age=="2012 and after"]==4)/length(state),
            X135ones_young=sum(X135[age=="2011 and before"]==1)/length(state), X135twos_young=sum(X135[age=="2011 and before"]==2)/length(state), X135threes_young=sum(X135[age=="2011 and before"]==3)/length(state), X135fours_young=sum(X135[age=="2011 and before"]==4)/length(state),
            X135ones_old=sum(X135[age=="2012 and after"]==1)/length(state), X135twos_old=sum(X135[age=="2012 and after"]==2)/length(state), X135threes_old=sum(X135[age=="2012 and after"]==3)/length(state), X135fours_old=sum(X135[age=="2012 and after"]==4)/length(state),
            X137ones_young=sum(X137[age=="2011 and before"]==1)/length(state), X137twos_young=sum(X137[age=="2011 and before"]==2)/length(state), X137threes_young=sum(X137[age=="2011 and before"]==3)/length(state), X137fours_young=sum(X137[age=="2011 and before"]==4)/length(state),
            X137ones_old=sum(X137[age=="2012 and after"]==1)/length(state), X137twos_old=sum(X137[age=="2012 and after"]==2)/length(state), X137threes_old=sum(X137[age=="2012 and after"]==3)/length(state), X137fours_old=sum(X137[age=="2012 and after"]==4)/length(state), 
            X138ones_young=sum(X138[age=="2011 and before"]==1)/length(state), X138twos_young=sum(X138[age=="2011 and before"]==2)/length(state), X138threes_young=sum(X138[age=="2011 and before"]==3)/length(state), X138fours_young=sum(X138[age=="2011 and before"]==4)/length(state),
            X138ones_old=sum(X138[age=="2012 and after"]==1)/length(state), X138twos_old=sum(X138[age=="2012 and after"]==2)/length(state), X138threes_old=sum(X138[age=="2012 and after"]==3)/length(state), X138fours_old=sum(X138[age=="2012 and after"]==4)/length(state),
            X139ones_young=sum(X139[age=="2011 and before"]==1)/length(state), X139twos_young=sum(X139[age=="2011 and before"]==2)/length(state), X139threes_young=sum(X139[age=="2011 and before"]==3)/length(state),
            X139ones_old=sum(X139[age=="2012 and after"]==1)/length(state), X139twos_old=sum(X139[age=="2012 and after"]==2)/length(state), X139threes_old=sum(X139[age=="2012 and after"]==3)/length(state)) %>%  
  ungroup()
```
...
summary_state_analysis_age<-summary_state_analysis_age %>% 
  ...
  dplyr::select(-X16ones_young, -X16ones_old, -X16twos_young, -X16twos_old,
                ...
                -X139ones_young, -X139ones_old, -X139twos_young, -X139twos_old, -X139threes_young, -X139threes_old)
