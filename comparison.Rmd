...
## Question 1: Age Weighted within Each State
...
q1full_plot <- ggplot(q1full_plot_dta, aes(x=q1full_plot_labels, y=q1full_plot, fill = q1full_plot_labels)) +
  ...
  scale_x_discrete(labels = function(q1full_plot_labels) str_wrap(q1full_plot_labels, width = 30)) +
...
## Question 1: Only State Weighted
...
## Question 1: Weighted by Overall Age Distribution Across the Country 
...
## Question 2: Age Weighted within Each State
...
## Question 2: Only State Weighted
...
## Question 2: Weighted by Overall Age Distribution Across the Country 
...
## Question 3: Age Weighted within Each State
...
## Question 3: Only State Weighted
...
## Question 3: Weighted by Overall Age Distribution Across the Country 
...
## Question 7: Age Weighted within Each State

Please select upto two States that you think have best fulfilled their pandemic management responsibilities. 

\vspace{6mm}
```{r}
q7full_mean_ones <- round(weighted.mean(summary_alt1.1$X130ones,
summary_alt1.1$state_weight)*100,3) 
q7full_mean_twos <- round(weighted.mean(summary_alt1.1$X130twos,
summary_alt1.1$state_weight)*100,3) 
...
q7full_plot_dta$wrapped_labels = str_wrap(q7full_plot_dta$q7full_plot_labels, width = 50)
q7full_plot <- ggplot(q7full_plot_dta, aes(x=q7full_plot_labels, y=q7full_plot, fill = q7full_plot_labels)) +
  ...
  scale_y_continuous(limits = c(0,100)) +
  scale_x_discrete(labels = function(q7full_plot_labels) str_wrap(q7full_plot_labels, width = 30)) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 7, Age Weighted Within Each State") +
  newtheme
...
## Question 7: Only State Weighted

Please select upto two States that you think have best fulfilled their pandemic management responsibilities. 

\vspace{6mm}
```{r}
q7full_mean_ones <- round(weighted.mean(summary_state_analysis$X130ones,
summary_state_analysis$state_weight)*100,3) 
q7full_mean_twos <- round(weighted.mean(summary_state_analysis$X130twos,
summary_state_analysis$state_weight)*100,3) 
...
q7full_plot <- ggplot(q7full_plot_dta, aes(x=q7full_plot_labels, y=q7full_plot, fill = q7full_plot_labels)) +
  ...
  scale_x_discrete(labels = function(q7full_plot_labels) str_wrap(q7full_plot_labels, width = 30)) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 7, Only State Weighted") +
  newtheme
...
## Question 7: Weighted by Overall Age Distribution Across the Country 

Please select upto two States that you think have best fulfilled their pandemic management responsibilities. 

\vspace{6mm}
```{r}
q7full_mean_ones_young <- round(weighted.mean(summary_alt1.3$X130ones_young,
summary_alt1.3$state_weight)*100,3) * sum(ias_processed_dta$post2012)/sum(ias_processed_dta$total)
q7full_mean_ones_old <- round(weighted.mean(summary_alt1.3$X130ones_old,
summary_alt1.3$state_weight)*100,3) * sum(ias_processed_dta$pre2012)/sum(ias_processed_dta$total)
q7full_mean_ones<-q7full_mean_ones_young+q7full_mean_ones_old

q7full_mean_twos_young <- round(weighted.mean(summary_alt1.3$X130twos_young,
summary_alt1.3$state_weight)*100,3) * sum(ias_processed_dta$post2012)/sum(ias_processed_dta$total)
q7full_mean_twos_old <- round(weighted.mean(summary_alt1.3$X130twos_old,
summary_alt1.3$state_weight)*100,3) *  sum(ias_processed_dta$pre2012)/sum(ias_processed_dta$total)
q7full_mean_twos<-q7full_mean_twos_young+q7full_mean_twos_old
...
q7full_plot <- ggplot(q7full_plot_dta, aes(x=q7full_plot_labels, y=q7full_plot, fill = q7full_plot_labels)) +
  ...
  scale_x_discrete(labels = function(q7full_plot_labels) str_wrap(q7full_plot_labels, width = 30)) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percent", caption = "Question 7, Overall Age Weighted") +
  newtheme
...
##The same comparisons excluding the problem states 
